    ...
    struct LdrpTlsListEntry
{
    ...
    extern (Windows) alias void* fnRtlAllocateHeap(void* HeapHandle, uint Flags, uint Size);
    ...
    static __gshared int* pNtdllBaseTag;

    static __gshared ubyte[] jmp_LdrpInitialize = [51,237,233];

    static __gshared ubyte[] jmp__LdrpInitialize = [93,233];

    static __gshared ubyte[] jmp__LdrpInitialize_xp64 = [93,144,144,144,144,144];

    static __gshared ubyte[] call_LdrpInitializeThread = [255,117,8,232];

    static __gshared ubyte[] call_LdrpAllocateTls = [0,0,232];

    static __gshared ubyte[] call_LdrpAllocateTls_svr03 = [101,252,0,232];

    static __gshared ubyte[] jne_LdrpAllocateTls = [15,133];

    static __gshared ubyte[] mov_LdrpNumberOfTlsEntries = [139,13];

    static __gshared ubyte[] mov_NtdllBaseTag = [81,139,13];

    static __gshared ubyte[] mov_NtdllBaseTag_srv03 = [80,161];

    static __gshared ubyte[] mov_LdrpTlsList = [139,61];
